...
ID of game you wish to update<input type="text" name="gid"><br>
New Game Title:<input type="text" name="title"><br>
New Game Summary:<input type="text" name="summary"><br>
New Game Description<input type="text" name="description"><br>
New Game Developer<input type="text" name="developer"><br>
New Game publisher<input type="text" name="publisher"><br>
New URL of image<input type="text" name="imageurl"><br>
New Date of release<input type="text" name="releasedate"><br>
