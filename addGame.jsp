...
Game Title:<input type="text" name="title"><br>
Game Summary:<input type="text" name="summary"><br>
Game Description<input type="text" name="description"><br>
Game Developer<input type="text" name="developer"><br>
Game publisher<input type="text" name="publisher"><br>
URL of image<input type="text" name="imageurl"><br>
Date of release<input type="text" name="releasedate"><br>
